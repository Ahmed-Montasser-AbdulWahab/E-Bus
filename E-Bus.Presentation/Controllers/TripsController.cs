    ...
    public class TripsController : Controller
    {
        ...
        public async Task<IActionResult> RegisterPostTrip([FromForm] ReservationAddRequest reservationAddRequest)
        {
            if (!ModelState.IsValid)
            {
                ...
                return RedirectToAction(nameof(RegisterTrip), "Trips", routeValues: new { area=null as string, tripId = reservationAddRequest.TripId }) ;
            }
            ...
            //Go to Ticket Page
            return RedirectToAction(actionName: nameof(ShowReservation), controllerName: "Trips", routeValues: new { area = null as string, tripId= reservationAddRequest.TripId, userId = reservationAddRequest.UserId  });
        }
